...
<body>
  ...
  状态：<asp:DropDownList ID="ddlState" runat="server">
       ...
       </asp:DropDownList><br />客户姓名：<input id="txtName" runat="server" type="text" />客户手机：<input id="txtTel" runat="server" type="text" />身份证：<input id="txtIdCard" runat="server" type="text" />
